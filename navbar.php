<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
            <a href="<?= base_url('pustakawan/alumni'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Alumni</p>
            </a>
            </li>
        ...
        <ul class="nav nav-treeview">
            <li class="nav-item">
            <a href="<?= base_url('pustakawan/penerbit'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Penerbit Buku</p>
            </a>
            </li>
            <li class="nav-item">
            <a href="<?= base_url('pustakawan/rak'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Rak Buku</p>
            </a>
            </li>
            ...
            <li class="nav-item">
            <a href="<?= base_url('pustakawan/buku/cetakbuku'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
        ...
        <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
            <a href="<?= base_url('pustakawan/bebaspinjam'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Surat Bebas Pinjam</p>
            </a>
            </li>
        </ul>
        </li>
        ...
        <ul class="nav nav-treeview">
        <li class="nav-item">
            <a href="<?= base_url('pustakawan/kirimpesan'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Kirim Pesan</p>
            </a>
            <?php if($aku['level'] == 'admin') : ?>
        ...
        <ul class="nav nav-treeview">
            <li class="nav-item">
            <a href="<?= base_url('pustakawan/profil'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Ubah Profil</p>
            </a>
            </li>
            <li class="nav-item">
            <a href="<?= base_url('pustakawan/password'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Ubah Password</p>
            </a>
            </li>
